                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="javascript:;" data-toggle="modal" data-target="#myModal" class="opera edit" category-id="{{ $v->id }}" name="{{ $v->name }}" des="{{ $v->des }}" sort="{{ $v->sort }}"><i class="table-edit"></i></a>
                                      <a href="{{ url('manage/category/del/'.$v->id) }}" class="opera del"><i class="table-delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('manage/category/add') }}" method="post">
